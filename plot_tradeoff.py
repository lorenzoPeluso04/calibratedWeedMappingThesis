...
# Carica i dati
csv_path = "benchmark_results/benchmark_summary_aggregate_merged_20.csv"
...
ax1.set_title("Spreco di Erbicida (Over-spraying Rate) (200 segments)", pad=15)
ax1.set_xlabel(r"Soglia Operativa $\tau$", labelpad=10)
ax1.set_ylabel("Pixel Sani Trattati (%)")
clean_spines(ax1)

# Configurazione Grafico Under-spraying
ax2.set_title("Erbacce Non Trattate (Under-spraying Rate) (200 segments)", pad=15)
...
output_plot = "evaluation_outputs/tradeoff_curves_thesis_200segments.png"
...
plt.tight_layout()
output_dca = "evaluation_outputs/decision_curve_analysis_net_benefit_200segments.png"
